...
if __name__ == "__main__":
    ...
    if FLAGS.base_mesh is None:
        ...
        torch.save(mat['kd_ks_normal'].state_dict(), os.path.join(os.path.dirname(FLAGS.ref_mesh), "mlp.pth"))
        ...
        torch.save(mat['kd_ks_normal'].state_dict(), os.path.join(os.path.dirname(FLAGS.base_mesh), "mlp.pth"))
